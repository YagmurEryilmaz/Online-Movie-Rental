...
public class GiftController {
    ...
    public ResponseEntity<Gift> createGift(@RequestBody GiftDto giftDto){
        return new ResponseEntity<>(giftService.addGift(giftDto.getSender_id(), giftDto.getReceiver_id(), giftDto.getM_id(), giftDto.getPay_id(),giftDto.getExpDate()),HttpStatus.CREATED);
    }
